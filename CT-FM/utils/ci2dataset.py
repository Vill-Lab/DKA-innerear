...
class Ci2Dataset(data.Dataset):#需要继承data.Dataset
    ...
    def __getitem__(self, index):
        ...
        if self.name == "train":
            ...
            return  tfs(img3d).numpy().transpose(0, 3, 1, 2) / 255.0, self.labels[index].to_numpy(dtype="float32"), self.ex_features[index]
            ...
            return rawdata.transpose(0, 3, 1, 2) / 255.0, self.labels[index].to_numpy(dtype="float32"), self.ex_features[index]
